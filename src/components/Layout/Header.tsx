      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          ...
          <Link to="/select-user-type">
            <button
              type="button"
              className="text-white bg-[#0056D2] hover:bg-white hover:border-2 hover:text-[#0056D2] hover:border-[#0056D2] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center"
            >
              Get Started
            </button>
          </Link>
